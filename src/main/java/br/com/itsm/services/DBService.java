...
public class DBService {
	...
	public void iniciaDB() {
		...
		Tecnico tec2 = new Tecnico(null, "Tecnico01", "45558622601", "tec1@email.com", "123");
		Tecnico tec3 = new Tecnico(null, "Tecnico02", "80828198209", "tec2@email.com", "123");
		Tecnico tec4 = new Tecnico(null, "Tecnico03", "52622813899", "tec3@email.com", "123");
		
		Cliente cli1 = new Cliente(null, "Cliente1", "48433273108", "cliente1@email.com", "123");
		Cliente cli2 = new Cliente(null, "Cliente2", "83686812002", "cliente2@email.com", "123");
		Cliente cli3 = new Cliente(null, "Cliente3", "04494853151", "cliente3@email.com", "123");
		Cliente cli4 = new Cliente(null, "Cliente4", "77367732110", "cliente4@email.com", "123");
